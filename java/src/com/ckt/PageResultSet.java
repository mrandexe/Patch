...
public class PageResultSet implements Pageable {
	...
	public PageResultSet(ResultSet rs) throws SQLException
	{
		if (rs==null)
		{
			throw new SQLException("Given ResultSet is NULL.");
		}
		rs.last();
		rowsCount = rs.getRow();
		rs.beforeFirst();
	...
	public NClob getNClob(int columnIndex) throws SQLException {
		rs.getNClob(columnIndex);
		return null;
	}

	public NClob getNClob(String columnLabel) throws SQLException {
		rs.getNClob(columnLabel);
		return null;
	}

	public SQLXML getSQLXML(int columnIndex) throws SQLException {
		rs.getSQLXML(columnIndex);
		return null;
	}

	public SQLXML getSQLXML(String columnLabel) throws SQLException {
		rs.getSQLXML(columnLabel);
		return null;
	}
	...
	public String getNString(String columnLabel) throws SQLException {
		rs.getNString(columnLabel);
		return null;
	}

	public Reader getNCharacterStream(int columnIndex) throws SQLException {
		rs.getNCharacterStream(columnIndex);
		return null;
	}

	public Reader getNCharacterStream(String columnLabel) throws SQLException {
		rs.getNCharacterStream(columnLabel);
		return null;
	}
