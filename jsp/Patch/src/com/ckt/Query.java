...
public class Query {
	...
	public static ArrayList<PatchDeployment> listPage(int curPage)
	{
		...
		try
		{
			...
			ArrayList<PatchDeployment> list = new ArrayList<PatchDeployment>();
	...
	public static ArrayList<PatchDeployment> listPage(String sql, List<String> ls)
	{
		Connection conn = null;
		PreparedStatement stmt = null;
		ResultSet rs = null;
	...
	public static ArrayList<PatchInfo> listPage(String sql, PatchInfo pi)
	{
		...
		try
        {
			...
			rs = stmt.executeQuery();
			//
			ArrayList<PatchInfo> list = new ArrayList<PatchInfo>();
			PatchInfo pInfo;
			while (rs.next())
			{
				pInfo = new PatchInfo();
